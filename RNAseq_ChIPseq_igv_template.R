...
setwd('/home/em_b/work_stuff/ChIP_RNA_comparison_templates')
...
#------DAVID pathway heatmaps RNAseq
chip<-read.csv('/home/em_b/work_stuff/ChIP_RNA_comparison_templates/H3K27me3_T3_0hr_RNAChIP.csv',
               row.names = 1)
...
#---enter in bam file
bamFile <- '/home/em_b/work_stuff/FCCC/chipseq/bam/I1.0h.ME3.rmdup.sort.bam'
...
bamFile <- '/home/em_b/work_stuff/FCCC/chipseq/bam/I3.T3.Me3.rmdup.sort.bam'
alignments <- readGAlignments(bamFile, use.names=TRUE, param=param)
track <- GenomicAlignmentTrack(trackName='h3k27me3_T3', alignments, visibilityWindow=10000000, trackHeight=200) 
track
displayTrack(igv, track)
tbl.pk <- read.delim('/home/em_b/work_stuff/FCCC/chipseq/macs/I3/I3_C3_peaks.narrowPeak',
                     header=FALSE)
