...
VlnPlot(data_subset, features = c('OLIG2','SOX2','SOX9','SOX10','MOG','VIM',
                                  ...
                                  'MAP2','NOTCH1','TUBB2B','GAS1','PDGFA'),
        cols = c())
VlnPlot(data_subset, features = c('GFAP','EZH2','SUZ12','THRA','S100B','IL6ST'))#,
        #cols = c('red'))
#-------------------------------------------------------------------------------
...
cds <- order_cells(cds, reduction_method = "UMAP",
                   root_cells = colnames(cds[,clusters(cds)=='reactive_OPC']))
p1<-plot_cells(cds,
...
p2<-DimPlot(data_subset,
        ...
        dims = c(1,2))
p1+p2
VlnPlot(data_subset, features = c('SOX2','MYC','CD44'))
